...
data = jqdatasdk.get_industries()
print(f'data:{data=}')

data = jqdatasdk.get_security_info2('000300.XSHG')
print(f'data:{data=}')
...
data = jqdatasdk.get_price(security='000300.XSHG', start_date = '2023-04-10', end_date = '2023-04-20', frequency='daily')
print(f'data:\n{data}')
